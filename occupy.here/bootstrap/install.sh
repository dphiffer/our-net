...
symlink /opt/usr/lib/libcurl.so.4.3.0 /usr/lib/libcurl.so.4.3.0
symlink /opt/usr/lib/libcurl.so.4.3.0 /usr/lib/libcurl.so.4
...
cp /usb/occupy.here/bootstrap/step6/dnsmasq.conf.* /etc/
rm /etc/dnsmasq.conf
ln -s /etc/dnsmasq.conf.lan-mode /etc/dnsmasq.conf

# Set up /etc/config/network
cp /usb/occupy.here/bootstrap/step6/network.* /etc/config/
rm /etc/config/network
ln -s /etc/config/network.lan-mode /etc/config/network
