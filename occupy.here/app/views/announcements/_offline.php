<div class="announcement<?php if (true || !empty($has_seen)) { echo ' minimized'; } ?>" id="offline_announcement">
  <a href="#" class="close top-right">&times;</a>
  <h2><?php echo _('Welcome to Our Net!'); ?></h2>
  ...
  <div class="buttons">
    <a href="/intro/" class="button"><?php echo _('About') . ' Our Net'; ?></a><a href="#" class="close button"><?php echo _('Hide'); ?></a>
  </div>
</div>
